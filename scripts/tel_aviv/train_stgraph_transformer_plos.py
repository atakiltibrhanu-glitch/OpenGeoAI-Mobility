...
BEST_MODEL_PATH = os.path.join(OUT_DIR, "best_stgraph_transformer.pt")
RESULTS_PATH = os.path.join(OUT_DIR, "stgraph_transformer_results.csv")
PRED_PATH = os.path.join(OUT_DIR, "stgraph_transformer_predictions.csv")
...
print("\n=== ST-GRAPH TRANSFORMER TEST RESULTS ===")
